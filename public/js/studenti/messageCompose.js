(function () {
    document.addEventListener('DOMContentLoaded', function () {
        const form = document.getElementById('studentComposeMessageForm');
        ...
        if (form && body) {
            form.addEventListener('submit', function (event) {
                ...
                if (plainText === '') {
                    ...
                    window.alert(window.cqT('student.communications.compose.body_required', 'Inserisci il testo del messaggio.'));
