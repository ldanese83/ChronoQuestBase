(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const markAllButton = document.getElementById('markAllAlertsReadButton');
        if (markAllButton) {
            markAllButton.addEventListener('click', function () {
                ...
                postJson('/docenti/alerts/read-all')
        ...
        document.querySelectorAll('[data-alert-open-url]').forEach(function (link) {
            link.addEventListener('click', function (event) {
                event.preventDefault();
                const url = link.getAttribute('data-alert-open-url');
                if (url) {
