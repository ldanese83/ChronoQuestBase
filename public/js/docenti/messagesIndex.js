(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const table = $('#messagesTable').DataTable({
            ...
            language: {
                search: 'Cerca:',
                lengthMenu: 'Mostra _MENU_ messaggi',
                info: 'Visualizzazione da _START_ a _END_ di _TOTAL_ messaggi',
                infoEmpty: window.cqT('js.messages.none_available', 'Nessun messaggio disponibile'),
                infoFiltered: '(filtrati da _MAX_ messaggi totali)',
        ...
        $('#btnEliminaMessaggiSelezionati').on('click', function () {
            ...
            fetch('/docenti/messages/delete', {
                ...
                .then(function (payload) {
                    ...
                    showAlert('success', payload.message || 'Messaggi eliminati con successo.');
