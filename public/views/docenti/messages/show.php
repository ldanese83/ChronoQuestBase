        ...
        <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
                <div class="mb-2 text-muted small">
                    <strong><?= $translator->translate('messages.from') ?>:</strong> <?= htmlspecialchars((string) ($message['student_name'] ?? '')) ?><br>
                    <strong>Email:</strong> <?= htmlspecialchars((string) ($message['student_email'] ?? '')) ?><br>
                ...
                <div class="text-end">
                    <button class="btn btn-success" data-toggle="modal" data-target="#modalRispostaMessaggio">
        ...
        <div class="modal fade" id="modalRispostaMessaggio" tabindex="-1" aria-labelledby="modalRispostaMessaggioLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <form id="teacherReplyMessageForm" method="post" action="/docenti/messages/<?= (int) $message['id'] ?>/reply">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="replySubject" class="form-label"><?= $translator->translate('messages.object_a') ?></label>
                            ...
                            <div class="mb-3">
                                <label for="replyBody" class="form-label"><?= $translator->translate('messages.text_a') ?></label>
                                <textarea id="replyBody" name="testoRisposta" class="form-control" rows="8"></textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal"><?= $translator->translate('teacher.quest.import_export.cancel') ?></button>
