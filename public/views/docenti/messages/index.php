    ...
    <?php if ($permissionStatus === PermissionService::STATUS_OK): ?>
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                ...
                <span style="font-size:12pt;font-style: italic;">
                    anno <?= htmlspecialchars((string) ($classroom['anno_scolastico'] ?? '')) ?>
                </span>
            </h1>
        </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">All Messagges:</h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge <?= $message['isRead'] ? 'bg-secondary' : 'bg-success' ?>">
                                            <?= $message['isRead'] ? 'Letto' : 'Non letto' ?>
                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <a href="/docenti/messages/<?= (int) $message['id'] ?>" class="btn btn-sm btn-primary shadow-sm">Leggi</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
