...
<body id="page-top">
    <!-- Page Wrapper -->
    <div id="wrapper">
        <!-- Navbar dedicata area docenti. -->
        <?php require __DIR__ . '/../partials/navbarDoc.php'; ?> 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content" >
                    ...
                    <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" style="background-color: #0d1b2a;">
                        ...
                        <div id="motto"><?= $translator->translate('motto') ?></div>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item" href="/testcreator/begin">
                                        <i class="fas fa-book fa-sm fa-fw mr-2 text-gray-400"></i>
                                        Test Creator
                                    </a>
                                    <a class="dropdown-item" href="/docenti/profilo">
                                        <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                        <?= $translator->translate('profile') ?>
                                    </a>
                                    <a class="dropdown-item" href="/docenti/plugin">
                                        <i class="fas fa-puzzle-piece fa-sm fa-fw mr-2 text-gray-400"></i>
                                        <?= $translator->translate('plugin.manage.menu') ?>
                                    </a>
